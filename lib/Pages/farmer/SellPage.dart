  ...
  Future<void> _handleSubmit() async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        ...
        final String unit =
            _selectedUnit == 'Other' ? _customUnit! : _selectedUnit!;
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSectionHeader(
                              'Product Image', Icons.image_outlined),
                          const SizedBox(height: 16),
                          ...
                          _buildSectionHeader(
                              'Pricing & Stock', Icons.monetization_on_outlined),
                          const SizedBox(height: 16),
                                    ...
                                    Expanded(
                                      child: CustomTextField(
                                        ...
                                        prefix: Text(
                                          '₱',
                                          style:
                                              AppTextStyles.PESO_SYMBOL.copyWith(
                                            fontSize: 18,
                          ...
                          _buildSectionHeader(
                              'Unit of Sale', Icons.shopping_basket_outlined),
                          const SizedBox(height: 16),
